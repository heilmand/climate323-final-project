...
#
# Elise 💗: Plotting original data and retrieving it from OMNI, plotting 4/23/23 CME data and analysis, power spectrum plots, finding dominant frequencies, ifft/removing frequencies, trying binary analysis with different windows sizes and solar wind threshold, and making majority of plots pink. 
#
